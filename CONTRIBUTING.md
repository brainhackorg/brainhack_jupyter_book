...
- A recent version of Python
  ([Python](https://www.python.org/downloads/)) to work on the book
  and view it locally. If you do not have Python on your computer, we warmly
  recommend the install instruction from the
